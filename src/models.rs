...
impl<'de> Deserialize<'de> for Eu4Save {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct Eu4SaveFlatten {
            ...
            #[jomini(default, deserialize_with = "deserialize_vec_pair_1400")]
...
pub struct Country {
    ...
    #[jomini(default, deserialize_with = "deserialize_vec_pair_24")]
    pub flags: Vec<(Eu4String, Eu4Date)>,
    ...
    #[jomini(default, deserialize_with = "deserialize_vec_pair_8")]
    pub active_idea_groups: Vec<(Eu4String, u8)>,
    #[jomini(default, deserialize_with = "deserialize_vec_pair_51")]
